...
Usage:
    python scripts/visualization/widgets/wv_grid_recording_controls.py
    xvfb-run --auto-servernum python scripts/visualization/widgets/wv_grid_recording_controls.py
"""
...
def main() -> None:
    ...
    print("=" * 60)
    print("\nScreenshots saved to: scripts/visualization/widgets/output/")
