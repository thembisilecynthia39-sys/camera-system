...
Usage:
    uv run python scripts/experiments/pyav/15_multicam_record_test.py
    uv run python scripts/experiments/pyav/15_multicam_record_test.py --duration 60
    uv run python scripts/experiments/pyav/15_multicam_record_test.py --devices /dev/video2 /dev/video4
