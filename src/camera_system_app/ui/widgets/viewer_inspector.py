...
class ViewerInspector(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.display_mode_combo = SafeComboBox()
        ...
        self.quality_combo = SafeComboBox()
        ...
        self.sphere_color_mode = SafeComboBox()
        ...
        self.camera_mode_combo = SafeComboBox()
        ...
        self.bookmark_combo = SafeComboBox()
        ...
        self.tone_mapping_combo = SafeComboBox()
        ...
        self.sh_degree_combo = SafeComboBox()
        ...
        self.resolution_preset_combo = SafeComboBox()
        ...
        self.fps_preset_combo = SafeComboBox()
