...
Usage:
    # Headless (CI/remote)
    xvfb-run --auto-servernum python scripts/visualization/widgets/wv_main_window.py

    # With display (interactive)
    python scripts/visualization/widgets/wv_main_window.py
"""
...
def main() -> None:
    ...
    print("=" * 60)
    print()
    print("Check screenshots in scripts/visualization/widgets/output/")
    print()
