...
class MainWindow(QMainWindow):
    ...
    def __init__(self, project_path: Path, parent=None) -> None:
        ...
        # Let Qt paint the workstation before device discovery, profile
        # matching, camera warm-up, or optional subsystems start doing work.
        QTimer.singleShot(0, self._start_capture_async)
