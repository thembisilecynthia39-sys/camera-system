...
service_script = "/home/lab/3DGS/Multcamera/multiwebcam/scripts/inference_service.py"
...
- If camera discovery is unstable, run `scripts/diagnose_usb_cameras.py` and compare `bus_info` values against `multiwebcam.toml`.
