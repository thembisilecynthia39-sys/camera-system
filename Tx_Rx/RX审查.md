...
> [!NOTE]
> 文档性质：WSL 接收端协议基线和联调记录，不是用户操作指南。文中 `/home/yp/...` 等路径属于当时的外部 WSL 环境；阅读当前 Jetson 客户端时，请先看 [`../README.md`](README.md) 和[当前实现报告](markdown/TX纯Python_HTTP客户端实现报告.md)。

审查范围：

```text
/home/yp/GaussianObject/camera_system/Tx_Rx
...
```bash
cd /home/yp/GaussianObject/camera_system/Tx_Rx

PYTHONPATH=. /home/yp/miniconda3/envs/mvsplat/bin/python \
  -m tx_rx.server \
  --config rx_config.yaml
```

入口文件：

```text
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/server/__main__.py:15
```
...
```text
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/server/application.py:13
```
...
```text
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/server/application.py:17
```
...
```text
/home/yp/GaussianObject/camera_system/Tx_Rx/rx_config.yaml
```
...
```text
/home/yp/GaussianObject/camera_system/Tx_Rx/rx_config.simulation.yaml
```

配置模型及字段限制：

```text
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/server/config.py:18
```

Jetson 客户端配置：

```text
/home/yp/GaussianObject/camera_system/Tx_Rx/config.yaml
```
...
```text
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/server/http_server.py:66
```
...
```text
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/server/http_server.py:186
```
...
```text
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/server/multipart.py:64
```
...
```text
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/protocol/models.py:32
```
...
```text
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/jetson_client/task_manifest.py:200
```
...
```text
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/server/archive_validator.py:41
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/protocol/models.py:74
```
...
```text
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/server/http_server.py:134
```
...
```text
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/protocol/models.py:103
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/server/http_server.py:153
```
...
```text
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/protocol/models.py:126
```
...
```text
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/jetson_client/result_client.py:123
```
...
```text
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/protocol/models.py:144
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/server/http_server.py:179
```
...
```text
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/server/multipart.py:15
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/server/multipart.py:150
```
...
PYTHONPATH=. /home/yp/miniconda3/envs/mvsplat/bin/python \
  -m tx_rx.server \
  --config rx_config.simulation.yaml
```
...
PYTHONPATH=. /home/yp/miniconda3/envs/mvsplat/bin/python \
  -m tx_rx.jetson_client.simulate \
...
```text
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/jetson_client/simulate.py:145
```
...
```text
/home/yp/GaussianObject/camera_system/Tx_Rx/tools/fake_baseline.py
```
...
```text
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/jetson_client/simulate.py
/home/yp/GaussianObject/camera_system/Tx_Rx/tools/fake_baseline.py
/home/yp/GaussianObject/camera_system/Tx_Rx/rx_config.simulation.yaml
```
...
```text
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/protocol/models.py
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/protocol/__init__.py
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/server/http_server.py
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/server/task_registry.py
/home/yp/GaussianObject/camera_system/Tx_Rx/tests/test_closed_loop.py
/home/yp/GaussianObject/camera_system/Tx_Rx/pyproject.toml
/home/yp/GaussianObject/camera_system/Tx_Rx/README.md
```
...
```text
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/server/reconstruction.py:29
```
...
```text
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/server/baseline_adapter.py:27
```
...
```text
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/server/baseline_adapter.py:69
/home/yp/GaussianObject/camera_system/Tx_Rx/tx_rx/server/reconstruction.py:174
```
